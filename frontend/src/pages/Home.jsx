...
const Home = ({username, email, password, setUsername, setEmail, setPassword}) => {
    ...
    if (loading) return  <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100">
        <div className="w-16 h-16 border-8 border-t-8 border-gray-300 border-t-blue-500 rounded-full animate-spin">
        </div>
        <p className='mt-2 text-sm'>Fetching data, please wait...</p>
    </div>
